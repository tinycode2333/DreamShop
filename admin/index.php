...
<title>后台</title>
    ...
    <link rel="stylesheet" href="styles/backstage.css" type="text/css">
</head>

<body>
    <div class="head">
            <div class="logo fl"><a href="#"></a></div>
            <h3 class="head_text fr">夢中の后台管理系统</h3>
    </div>
    ...
    <script type="text/javascript">
        function show(getmenu,getchange){
            var menu=document.getElementById(getmenu);
            var change=document.getElementById(getchange);
            if(change.innerHTML=="+"){
                change.innerHTML="-";
            }else{
                change.innerHTML="+";
